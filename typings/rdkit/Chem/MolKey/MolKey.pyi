...
def initStruchk(
    configDir: Optional[Any] = ..., logFile: Optional[Any] = ...
) -> None: ...
...
MolKeyResult = namedtuple(
    "MolKeyResult",
    ["mol_key", "error", "inchi", "fixed_ctab", "stereo_code", "stereo_comment"],
)

def GetKeyForCTAB(
    ctab: Any,
    stereo_info: Optional[Any] = ...,
    stereo_comment: Optional[Any] = ...,
    logger: Optional[Any] = ...,
): ...
