...
def TransformMol(
    mol: Any, tform: Any, confId: int = ..., keepConfs: bool = ...
) -> None: ...
def ComputeMolShape(
    mol: Any, confId: int = ..., boxDim: Any = ..., spacing: float = ..., **kwargs: Any
): ...
def ComputeMolVolume(
    mol: Any, confId: int = ..., gridSpacing: float = ..., boxMargin: float = ...
): ...
def GetConformerRMS(
    mol: Any,
    confId1: Any,
    confId2: Any,
    atomIds: Optional[Any] = ...,
    prealigned: bool = ...,
): ...
def GetConformerRMSMatrix(
    mol: Any, atomIds: Optional[Any] = ..., prealigned: bool = ...
): ...
def EnumerateLibraryFromReaction(
    reaction: Any, sidechainSets: Any, returnReactants: bool = ...
) -> None: ...
